...
import {IconButton, TextField, Input, Grid, Button, Collapse, Slide, useScrollTrigger, AppBar, Toolbar} from '@material-ui/core';
...
const ManageAccount = (props) => {
  ...
  return (
    <div className={classes.container}>
      ...
      <Toolbar/>*/}
      <ExpansionPanel square expanded={expanded === 'panel1'} onChange={handleChange('panel1')} style={{width:'100%'}}>
        ...
        <ExpansionPanelDetails>
          <Grid container direction="column" justify="center" alignItems="flex-start" spacing={1}>
            <Grid item xs>
              <TextField disabled label="Hospital Name" defaultValue={selectedHospital.properties.cfname} fullWidth/>
            </Grid>
            ...
            <Grid item xs>
              <TextField disabled label="City/Municipality" defaultValue={selectedHospital.properties.city} fullWidth/>
            </Grid>
            <Grid item container direction="row" justify="center" alignItems="flex-start" spacing={2}>  
              <Grid item xs={6}>
