...
import FaceGroup from './faceStyles';
...
const PersonItem = ({ src, name, friendCount }) => {
  ...
  return (
    <Row gap={2} p={2.5} style={{height:100}}>
      <Row wrap grow gap={0.5} minWidth={0}>
        ...
        <Item style={{ width:300, height:50, whiteSpace: "nowrap"}}><FaceGroup/></Item>
  ...
  return (
    <>
      ...
      <Column p={0} gap={0} className={styles.card}>
        ...
        <div style={{height:200,overflow: 'auto', margin:"0 10px"}}>
