    ...
    <div className={classes.container}>
      <Grid container direction="row" justify="flex-start" alignItems="flex-start" spacing={0}>
        <Grid item xs={5}>
          ...
          <Typography style={{fontSize:12, fontWeight:350, textAlign:'center'}}>{hos.properties["DOH Level"]}</Typography><br/>
          <Typography style={{fontSize:12, fontWeight:500}}>Address:</Typography>
          <Typography style={{fontSize:12, fontWeight:350, textAlign:'center'}}>{hos.properties.Address}</Typography><br/>
          <Typography style={{fontSize:12, fontWeight:500}}>Region:</Typography>
          <Typography style={{fontSize:12, fontWeight:350, textAlign:'center'}}>{hos.properties.Region}</Typography><br/>
          <Typography style={{fontSize:12, fontWeight:500}}>Head/Contact Person:</Typography>
          <Typography style={{fontSize:12, fontWeight:350, textAlign:'center'}}>{hos.properties.Head} </Typography><br/>
          <Typography style={{fontSize:12, fontWeight:500}}>Contact Number/s:</Typography>
          <Typography style={{fontSize:12, fontWeight:350, textAlign:'center'}}>{hos.properties["Contact Numbers"]}</Typography><br/>
          <Typography style={{fontSize:12, fontWeight:500}}>Website:</Typography>
          <Typography style={{fontSize:12, fontWeight:350, textAlign:'center'}}>{hos.properties.Website}</Typography><br/>
        </Grid>
        <Grid item xs={7}>
          <TableContainer>
